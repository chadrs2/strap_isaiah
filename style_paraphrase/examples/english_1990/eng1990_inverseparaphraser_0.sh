...
export DATA_DIR=datasets/english_1990

BASE_DIR=style_paraphrase

# Trains the InverseParaphraser and saves to 'model_custom_eng1990'
python3 -m torch.distributed.launch --nproc_per_node=1 $BASE_DIR/run_lm_finetuning.py \
    --output_dir=$BASE_DIR/saved_models/model_custom_bom \
    --model_type=gpt2 \
